...
// Textual 0.5.0 (https://github.com/gonzalezreal/textual, MIT, Copyright (c)
// 2024 Guille Gonzalez), vendored for one change: `StructuredText` parses
// while drawing instead of after its first frame. Tests and the snapshot
// dependency are left out.
