...
public enum Workspace {
    ...
    /// the worktree. Suffixes `-1`, `-2`… until both are unused.
    public static func provision(
        ...
        let baseSlug = WorktreeNaming.slugify(name)
        ...
        for attempt in 0..<50 {
            ...
            let path = WorktreeNaming.render(
                ...
                slug: slug, branch: branch, prefix: prefix
            )
        ...
        throw BacktickError.message("Could not find a free worktree path or branch name for “\(name)”.")
    }
